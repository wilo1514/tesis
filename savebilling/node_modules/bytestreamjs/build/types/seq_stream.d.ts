import { ByteStream, FindFirstNotInResult, FindFirstSequenceResult, FindPairedArraysResult, FindPairedPatternsResult } from "bytestreamjs/build/types/byte_stream";
...
export declare class SeqStream {
     ...
     * @returns
     */
    findFirstIn(patterns: ByteStream[], gap?: null | number): import("bytestreamjs/build/types/byte_stream").FindFirstInResult | {
        id: number;
        position: number;
    };
    /**
     ...
     * @returns
     */
    findAllIn(patterns: ByteStream[]): import("bytestreamjs/build/types/byte_stream").FindResult[];
    /**
     ...
     * @returns
     */
    replacePattern(searchPattern: ByteStream, replacePattern: ByteStream): import("bytestreamjs/build/types/byte_stream").ReplacePatternResult;
    /**
